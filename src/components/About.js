    ...
    <section>
      <div className="about-container scroll-area" id="about">
        <div className="about-container_text">
          <h2>&#123;about me&#125;</h2>
          <p>
            My name is Laura García. I'm a frontend programmer who likes to work
            with good practices and high attention to detail. Usability and UX
            are in my constant focus. When I'm not programming you can find me
            taking pictures, or practicing calligraphy.
          </p>
        </div>
